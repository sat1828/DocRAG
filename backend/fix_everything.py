"""
Fix all files with correct Python syntax.
Run: python fix_everything.py
"""
import os

base = r"D:\Multi\indian-sme-doc-intelligence-rag\backend\app"

# 1. SECURITY.PY - Fixed with proper dict syntax
security_content = '''"""
...
# 2. AUTH.PY - Fixed with proper syntax
auth_content = '''"""
...
# Write all files
files = {
    os.path.join(base, "core", "security.py"): security_content,
    os.path.join(base, "routers", "auth.py"): auth_content,
    os.path.join(base, "core", "config.py"): config_content,
}
...
print("\nDone! Now run: python -m pytest backend/tests/ -v")
